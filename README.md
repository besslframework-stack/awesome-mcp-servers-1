...
- **[Tessera](https://github.com/besslframework-stack/project-tessera)** - Personal knowledge layer with cross-session memory, 40+ file type search, cross-AI portability (ChatGPT/Gemini export/import), contradiction detection, and AES-256 encryption. 53 MCP tools, 34 HTTP endpoints. 100% local, no API keys.
